...
function poc_setup() {
	 ...
	 * If you're building a theme based on poc, use a find and replace
	 * to change 'poc' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'poc', get_template_directory() . '/languages' );
 ...
 */
function poc_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'poc_content_width', 640 );
}
add_action( 'after_setup_theme', 'poc_content_width', 0 );
...
add_action( 'widgets_init', 'poc_widgets_init' );
